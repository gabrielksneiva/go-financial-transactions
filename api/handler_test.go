...
func TestStatementHandler_NotFound(t *testing.T) {
	app, _, txRepoMock, balanceRepo, userRepoMock := setupTestApp()
	...
	balanceRepo.On("GetBalance", mock.AnythingOfType("uint")).Return(nil, errors.New("balance not found")) // <-- Aqui mudamos para um erro
